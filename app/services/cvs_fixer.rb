...
# Read the CSV file and correct the formatting issues
def fix_csv(input_file, output_file)
  ...
  CSV.open(output_file, 'w', write_headers: true, headers: fixed_rows.first.headers, quote_char: '"', col_sep: ',') do |csv|
